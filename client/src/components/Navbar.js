...
const Navbar = () => {
  ...
  return (
    <nav className="navbar navbar-expand-lg shadow-sm sticky-top" style={{ backgroundColor: '#28a745' }}>
          ...
          <ul className="navbar-nav ms-auto align-items-center">
            ...
            {user ? (
              ...
              <>
                ...
                <li className="nav-item mx-1">
                  <Link className="btn btn-light text-success px-3 py-2 ms-2" to="/signup">
